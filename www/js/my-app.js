...
///////////////////////// iniciar dom /////////////////////////
var $$ = Dom7;
var $server = 'http://bynn.es/caupe/';
var $serverCau = 'http://www.caupe.gov.br/api/';
            ...
            success: function(data) {
                    ...
                    for (var i = 0; i < qtd; i++) {
                        ...
                        dataLocal += '<div class="local-container">'+
                                    ...
                                    '<div class="local-map">'+
                                        '<a href="#">'+
                                            '<img src="https://maps.googleapis.com/maps/api/staticmap?size=480x300&zoom=18&markers=icon:http://www.bynn.es/caupe/admin/img/maker-caupe.png|'+data.oferta[i].EmpresaEndereco+','+data.oferta[i].EmpresaNumero+','+data.oferta[i].EmpresaBairro+','+data.oferta[i].EmpresaCidade+','+data.oferta[i].EmpresaEstado+'">'+
                                        '</a>'+
                                    '</div>';
...
/* list noticias */
function noticias() {
    var url = $serverCau + "?json=get_category_posts&count=30&id=8";
    $("#noticias-cont").empty();
...
function instagram(){
    ...
    jQuery.fn.spectragram.accessData = {
        accessToken: '5689976605.1677ed0.87e69173140f4f5ca60705eaee745663'
    };
